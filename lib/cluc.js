...
var Cluc = (function(){
  ...
  Cluc.prototype.processTemplate = function(str){
    var that = this;
    var values = that.savedValues;
    var helpers = {
      quote: function(key){
    ...
    if(_.isArray(str) ){
      return _.map(str, function(v) {
        return that.processTemplate(v);
      });
    }
    if(_.isObject(str) ){
      return _.each(str, function(v, k) {
        str[k] = that.processTemplate(v);
      });
    }
    if(_.isString(str) ){
