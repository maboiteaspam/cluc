...
var ClucChildProcess = (function(){
  ...
  ClucChildProcess.prototype.prependFile = function(path, content, then){
    prependFile(path, content, function(err) {
      then(err, !err);
    });
  };
  ClucChildProcess.prototype.prependFileSudo = function(path, content, then){
    prependFile(path, content, function(err) {
      then(err, !err);
    });
  };
